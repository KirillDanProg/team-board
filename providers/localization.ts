export const ruRU = {
  ...
  badge__you: "Вы",
  createOrganization: {
    formButtonSubmit: "Создать проект",
    invitePage: {
  ...
  formFieldLabel__organizationName: "Название проекта",
  ...
  organizationProfile: {
    ...
    membersPage: {
      ...
      invitationsTab: {
        ...
        table__emptyRow: "Приглашения отсутствуют",
      },
      invitedMembersTab: {
    ...
    profilePage: {
      dangerSection: {
        deleteOrganization: {
          ...
          messageLine1: "Вы уверены, что хотите удалить этот проект?",
          messageLine2: "Это действие нельзя отменить.",
          successMessage: "Вы удалили проект.",
          title: "Удалить проект",
        },
        leaveOrganization: {
          actionDescription: 'Type "{{organizationName}}" below to continue.',
          messageLine1:
            "Вы уверены, что хотите покинуть этот проект? Вы потеряете доступ к этому проекту и его приложениям.",
          messageLine2: "Это действие нельзя отменить.",
          successMessage: "Вы покинули проект.",
      ...
      domainSection: {
        ...
        subtitle:
          "Разрешите пользователям присоединяться к проекту автоматически или по запросу, если домен их электронной почты верифицирован.",
        title: "Верифицированные домены",
      },
      successMessage: "Проект был обновлен.",
  ...
  organizationSwitcher: {
    action__createOrganization: "Создать проект",
    action__invitationAccept: "Принять",
    action__manageOrganization: "Управление проектом",
    action__suggestionsAccept: "Запрос на вступление",
  ...
  signIn: {
    accountSwitcher: {
      ...
      subtitle: "Выберите аккаунт в котором хотите продолжить.",
